...
export default async function decorate(block) {
  ...
  const headerHTML = [
    ...
    '      <path d="M6.75595 8.51326C6.25593 6.62311 5.31966 4.84218 4.02289 3.22412C2.91047 1.97475 1.56004 0.88447 0.029673 0C1.51395 2.34596 2.51273 6.73359 2.51273 11.7595C2.51273 16.7854 1.51584 21.1629 0.0347248 23.5114C0.0113641 23.5644 0 23.5909 0 23.5909C2.3833 21.9337 7.03753 13.5063 7.13918 11.7999C7.13918 10.6679 7.00659 9.56819 6.75658 8.51263Z" fill="white"></path>',
    '      <path d="M20.924 0H12.9211V23.5909H16.949V15.0909H20.924C25.606 15.0909 28.738 11.858 28.738 7.54546C28.738 3.23296 25.606 0 20.924 0ZM20.4183 11.2506H16.949V3.84028H20.4183C23.1804 3.84028 24.6293 5.32261 24.6293 7.54546C24.6293 9.76832 23.1804 11.2506 20.4183 11.2506Z" fill="white"></path>',
    '      <path d="M35.7884 7.20312C31.0779 7.20312 27.6719 11.0062 27.6719 15.6274C27.6719 20.1488 30.9308 24.0005 35.6627 24.0005C39.077 24.0005 42.1851 21.9531 43.3594 18.7644H39.2153C38.5732 19.6179 37.3156 20.3427 35.6886 20.3427C33.0957 20.3427 31.917 18.4916 31.7806 17.0781H43.6321C43.7394 15.342 43.7394 10.4474 35.7884 7.20312Z" fill="white"></path>',
    '      <path d="M53.0912 7.20117C48.3757 7.20117 44.5416 10.8805 44.5416 15.6734C44.5416 20.1614 47.9035 24.0086 52.4472 23.9992C54.7346 23.9947 56.539 23.0143 57.4771 21.5932V23.5907H61.5834V15.3925C61.5834 10.7731 57.7385 7.20117 53.0912 7.20117Z" fill="white"></path>',
    '      <path d="M73.9591 7.71386C73.5115 7.50426 72.5399 7.20312 71.4306 7.20312C68.2329 7.20312 66.8521 9.93671 66.8521 9.93671V7.61221H63.0123V23.5908H67.0548V13.1368C67.1659 12.9209 68.3036 10.9803 70.6591 10.9803C71.5398 10.9803 72.3416 11.2517 72.5449 11.3509L73.9591 7.71386Z" fill="white"></path>',
    '      <path d="M95.5237 7.20117C90.7741 7.20117 86.9899 10.9215 86.9899 15.6033C86.9899 20.2851 90.7621 23.9903 95.5117 23.9903C100.261 23.9903 104.033 20.2814 104.033 15.6002C104.033 10.919 100.273 7.20117 95.5237 7.20117Z" fill="white"></path>',
    '      <path d="M112.226 7.20312C108.226 7.20312 104.993 10.4342 104.993 14.4355V23.5908H109.049V14.4411C109.049 12.3736 110.518 11.056 112.22 11.056C113.92 11.056 115.38 12.3837 115.378 14.4519V23.5908H119.461V14.438C119.461 10.4367 116.227 7.20312 112.226 7.20312Z" fill="white"></path>',
    '    </svg>',
    '  </a>',
    '</div>',
